...
class Attachment
{
    ...
    public static function handelImg($img)
    {
        if ($img instanceof UploadedFile) {
            ...
            if (filter_var($img, FILTER_VALIDATE_URL)) {
                ...
                $fileContents = file_get_contents(asset('land/images/header.jpg'));
                $base = 'header.jpg';
            }
            $fileName = uniqid() . '_' . basename($base);
    ...
    public static function addAttachment($img, $model, $folder_name = 'global', array $options = []): void
    {

        $image = self::handelImg($img);
     ...
     * @param array $options
     */
    public static function updateAttachment($img, $oldFiles, $model, $folder_name, array $options = []): void
    {
        if ($oldFiles) {
